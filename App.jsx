...
export default function App() {
  ...
  return (
    <div style={{ fontFamily }} className="min-h-screen bg-slate-50 text-slate-800 flex flex-col">
      ...
      {/* 5. FOOTER (UPDATED 3-COLUMN LAYOUT) */}
      <footer style={{ backgroundColor: themeColors.footerBg }} className="py-12 px-8 text-white transition-colors mt-auto">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
          ...
          <div className="flex flex-col space-y-2">
            ...
            <p className="text-xs text-slate-100 leading-relaxed max-w-xs">
          ...
          <div className="text-xs text-slate-100 space-y-2">
            <p className="font-bold text-sm text-white mb-2">Why Parents Trust Us</p>
          ...
          <div className="text-xs text-slate-100 space-y-2">
            ...
            <p className="flex items-center gap-2">💬 Chat on WhatsApp (+91 99...)</p>
            <p className="flex items-center gap-2">✉️ support@paperbridge.co</p>
            <p className="flex items-center gap-2">📷 @paperbridge</p>
            <p className="flex items-center gap-2 pt-1">⏰ Mon–Sat (9 AM – 6 PM)</p>
          </div>
